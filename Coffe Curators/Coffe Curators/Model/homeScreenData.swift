...
class MainData {
    ...
    static var contentArray: [homeScreenData] {
        let dripCoffee = homeScreenData(title: "Drip Coffe", image: #imageLiteral(resourceName: "dripCoffee"), description: "Drip coffee is made by dripping boiling water over ground coffee, which is ground more coarsely than espresso coffee. The water filters through the coffee and falls into a pot. This process is slower than the espresso process, and hot.", storyboardName: "BrowserDrinks", storyboardID: "child2")
