//
//  ColdBrewDrinkTableViewController.swift
//  Coffe Curators
//
...
class ColdBrewDrinkTableViewController: UITableViewController {
    ...
    func fetch() {
        DrinkController.shared.fetchDrinks { result in
            ...
            case .success(let drinks):
                for drink in drinks {
                    if  drink.appliance == "Cold Brew" && drink.drinkCategory == "Hot" {
                        self.hotDrinks.append(drink)
                        print("This is Hot Drinks \(self.hotDrinks)")
                    } else if drink.appliance == "Cold Brew" && drink.drinkCategory == "Cold" {
                        self.coldDrinks.append(drink)
                        print("This is Cold Drinks \(self.coldDrinks)")
                    } else if drink.appliance == "Cold Brew" && drink.drinkCategory == "Blended" {
...
extension ColdBrewDrinkTableViewController: IndicatorInfoProvider {
